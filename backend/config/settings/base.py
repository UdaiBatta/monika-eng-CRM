...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("POSTGRES_DB", "monika_erp"),
        "USER": os.getenv("POSTGRES_USER", "monika_erp"),
        "PASSWORD": os.getenv("POSTGRES_PASSWORD", "monika_erp_dev"),
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": ["apps.core.authentication.SessionAuthenticationWithChallenge"],
