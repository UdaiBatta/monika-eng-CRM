...
const Footer = () => {
    ...
    return (
        ...
        >
            <img className="dark:invert" src="/logo/templates/axis/light-logo.svg" alt="Light Logo" width={100} height={100} />
            ...
            <section className="flex flex-row gap-4">
                {socialLinks.map((link) => (
                    <a key={link.label} href={link.href}>
                        <img src={link.icon} alt={link.label} width={24} height={24} className="invert dark:invert-0 w-7 lg:w-8" />
                    </a>
                ))}
            </section>
